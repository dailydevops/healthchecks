...
/// <summary>
/// Options for <see cref="SqlServerDevartHealthCheck"/>
/// </summary>
public sealed record SqlServerDevartOptions
{
    /// <summary>
    ...
    /// </summary>
    /// <value>
    /// The SQL command to execute. Default value is defined by <see cref="SqlServerDevartHealthCheck.DefaultCommand"/>.
    /// </value>
    /// <remarks>
    /// This property is for internal use only.
    /// </remarks>
    public string Command { get; internal set; } = SqlServerDevartHealthCheck.DefaultCommand;
}
