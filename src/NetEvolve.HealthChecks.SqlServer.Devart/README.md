...
[![NuGet](https://img.shields.io/nuget/v/NetEvolve.HealthChecks.SqlServer.Devart?logo=nuget)](https://www.nuget.org/packages/NetEvolve.HealthChecks.SqlServer.Devart/)
[![NuGet](https://img.shields.io/nuget/dt/NetEvolve.HealthChecks.SqlServer.Devart?logo=nuget)](https://www.nuget.org/packages/NetEvolve.HealthChecks.SqlServer.Devart/)

This package provides a health check for SQL Server, based on the [Devart.Data.SqlServer](https://www.nuget.org/packages/Devart.Data.SqlServer/) package.
...
```powershell
dotnet add package NetEvolve.HealthChecks.SqlServer.Devart
```

## Health Check - SqlServerDevart Liveness
...
- `tags`: The tags for the health check. The tags `sqlserver`, `database` and `devart` are always used as default and combined with the user input. You can provide additional tags to group or filter the health checks.
...
builder.AddSqlServerDevart("<name>");
```
...
builder.AddSqlServerDevart("<name>", options =>
{
