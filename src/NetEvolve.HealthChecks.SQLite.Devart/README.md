...
This package provides a health check for SQLite, based on the [Devart.Data.SQLite](https://www.nuget.org/packages/Devart.Data.SQLite/) package.
...
## Health Check - SQLiteDevart Liveness
