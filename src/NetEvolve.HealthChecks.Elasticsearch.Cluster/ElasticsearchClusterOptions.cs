...
/// <summary>
/// Options for <see cref="ElasticsearchClusterHealthCheck"/>
/// </summary>
public sealed record ElasticsearchClusterOptions
{
    /// <summary>
    /// Gets or sets the mode used to create/retrieve a client instance.
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="ElasticsearchClusterClientCreationMode.ServiceProvider"/>.
    /// </remarks>
    public ElasticsearchClusterClientCreationMode Mode { get; set; } =
    ...
    /// <br/>
    /// This option is only used when <see cref="Mode"/> is set to <see cref="ElasticsearchClusterClientCreationMode.ServiceProvider"/>.
    /// </remarks>
    public string? KeyedService { get; set; }

    /// <summary>
    /// Gets or sets the connection strings to the Elasticsearch cluster instances to check.
    /// </summary>
    /// <remarks>
    /// This option is only required when <see cref="Mode"/> is set to <see cref="ElasticsearchClusterClientCreationMode.Internal"/>.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// This option is only used when <see cref="Mode"/> is set to <see cref="ElasticsearchClusterClientCreationMode.Internal"/>
    ...
    public Func<ElasticsearchClient, CancellationToken, Task<bool>> CommandAsync { get; internal set; } =
        ElasticsearchClusterHealthCheck.DefaultCommandAsync;
}
