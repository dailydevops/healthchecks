...
{
    private static readonly string[] _defaultTags = ["security", "azure", "keyvault"];

    /// <summary>
    /// Adds a health check for Azure Key Vault, to check the availability of the secret store.
    /// </summary>
