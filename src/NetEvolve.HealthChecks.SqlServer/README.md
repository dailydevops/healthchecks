...
This package uses configuration compatible with `SqlServer.Legacy` and `SqlServer.Devart`. You can switch implementations without changing your appsettings.json.
