...
internal sealed class OracleConfigure
    : IConfigureNamedOptions<OracleOptions>,
        IPostConfigureOptions<OracleOptions>,
        IValidateOptions<OracleOptions>
{
    private readonly IConfiguration _configuration;

    public OracleConfigure(IConfiguration configuration) => _configuration = configuration;
    ...
    public void PostConfigure(string? name, OracleOptions options)
    {
