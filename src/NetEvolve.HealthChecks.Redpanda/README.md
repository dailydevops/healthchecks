...
- `tags`: The tags for the health check. The tags `redpanda` and `messeging` are always used as default and combined with the user input. You can provide additional tags to group or filter the health checks.
