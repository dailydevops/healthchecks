...
The main purpose is to check if the MySQL database is available and if the database is online.
...
The health check is a liveness check. It checks if the MySQL database is available and if the database is online.
