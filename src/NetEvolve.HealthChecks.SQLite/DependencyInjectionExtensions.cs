...
public static class DependencyInjectionExtensions
{
    ...
    /// <summary>
    /// Add a health check for the SQLite database, based on <c>Microsoft.Data.Sqlite</c>.
    /// </summary>
    /// <param name="builder">The <see cref="IHealthChecksBuilder"/>.</param>
    /// <param name="name">The name of the <see cref="SQLiteHealthCheck"/>.</param>
    ...
    )
    {
        ...
        if (!builder.IsServiceTypeRegistered<SQLiteCheckMarker>())
        {
            _ = builder
                ...
                .AddSingleton<SQLiteHealthCheck>()
        ...
        return builder.AddCheck<SQLiteHealthCheck>(
            name,
