...
/// <summary>
/// Represents configuration options for the AWS CloudWatch health check.
/// </summary>
public sealed record CloudWatchOptions
{
    ...
    /// <summary>
    /// Gets or sets the name of the CloudWatch alarm to check.
    /// </summary>
    public string? AlarmName { get; set; }

    /// <summary>
    /// Gets or sets the creation mode for the CloudWatch client.
    /// </summary>
