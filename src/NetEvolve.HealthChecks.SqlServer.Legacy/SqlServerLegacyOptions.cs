...
/// <summary>
/// Options for <see cref="SqlServerLegacyHealthCheck"/>
/// </summary>
public sealed record SqlServerLegacyOptions
{
    /// <summary>
    ...
    /// </summary>
    /// <value>
    /// The SQL command to execute. Default value is defined by <see cref="SqlServerLegacyHealthCheck.DefaultCommand"/>.
    /// </value>
    /// <remarks>
    /// This property is for internal use only.
    /// </remarks>
    public string Command { get; internal set; } = SqlServerLegacyHealthCheck.DefaultCommand;
}
