...
/// <summary>
/// Options for <see cref="OracleDevartHealthCheck"/>
/// </summary>
public sealed record OracleDevartOptions
{
    /// <summary>
    ...
    /// </summary>
    /// <value>
    /// The SQL command to execute. Default value is defined by <see cref="OracleDevartHealthCheck.DefaultCommand"/>.
    /// </value>
    /// <remarks>
    /// This property is for internal use only.
    /// </remarks>
    public string Command { get; internal set; } = OracleDevartHealthCheck.DefaultCommand;
}