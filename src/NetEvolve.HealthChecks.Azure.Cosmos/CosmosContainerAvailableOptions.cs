...
/// <summary>
/// Options for the <see cref="CosmosContainerAvailableHealthCheck"/>.
/// </summary>
public sealed record CosmosContainerAvailableOptions : ICosmosOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the name of the container to check.
    /// </summary>
