...
public sealed class ElasticsearchClusterHealthCheckTests
{
    [Test]
    public async Task CheckHealthAsync_WhenContextNull_ThrowArgumentNullException()
    {
        ...
        var optionsMonitor = Substitute.For<IOptionsMonitor<ElasticsearchClusterOptions>>();
        var check = new ElasticsearchClusterHealthCheck(optionsMonitor, serviceProvider);
    ...
    public async Task CheckHealthAsync_WithKeyedService_ShouldUseKeyedService()
    {
        ...
        var healthCheck = new ElasticsearchClusterHealthCheck(optionsMonitor, serviceProvider);
        var context = new HealthCheckContext
        {
    ...
    public async Task CheckHealthAsync_WhenConnectionFails_ShouldReturnUnhealthy()
    {
        ...
        var options = new ElasticsearchClusterOptions
        {
            ...
            {
                await Task.CompletedTask;
                throw new InvalidOperationException("ElasticsearchCluster unhealthy test");
            },
        };
