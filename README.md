...
| [NetEvolve.HealthChecks.Azure.Search](https://www.nuget.org/packages/NetEvolve.HealthChecks.Azure.Search/) <br/><small>Contains HealthChecks for Azure Cognitive Search.</small> | [![NuGet Downloads](https://img.shields.io/nuget/dt/NetEvolve.HealthChecks.Azure.Search?logo=nuget&style=for-the-badge)](https://www.nuget.org/packages/NetEvolve.HealthChecks.Azure.Search/#readme-body-tab) |
